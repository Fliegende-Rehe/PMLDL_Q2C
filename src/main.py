...
from src.bot_token import API_TOKEN
...
scenario = [
    ...
    {'id': 1, 'label': 'What happend to your previous ID?',
     'prompts': ['ID is lost', 'ID is expired', 'Getting id first time'], 'type': 'choose', 'action': [
        'New ID instruction', 'Update ID instruction', 'First ID instruction'],
     'confirm': ['Is your ID lost?', 'Is your ID expired?', 'Do you want to get ID for the first time?']},
    ...
    {'id': 4, 'label': 'What document info do you want to get?',
     'prompts': ['ID', 'Driver License', 'Medical insurance'], 'type': 'choose', 'action': [
        'Getting ID info...', 'Getting Driver License info...', 'Getting medical insurance info...'],
     'confirm': ['Do you want to get ID info', 'Do you want to get driver license info?',
                 'Do you want to get medical unsurance info?']},
    ...
    {'id': 6, 'prompts': ['Appointment at the hospital', 'Get medical help'],
     'action': 'Setting an appointment for you...', 'type': 'initial',
     'confirm': 'Do you need to get an ppointment at the hospital?'},
]
...
Hi! This is a demo of a chatbot, which can recognise your text prompts and map them to some certain scenarios. Try it!
""")
